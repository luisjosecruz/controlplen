...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-02-2022 a las 05:46:01
...
INSERT INTO `proyectos` (`proyectoId`, `proyectoValor`, `proyectoNombre`, `proyectoDescripcion`, `proyectoEstado`, `proyectoEtiquetas`, `proyectoFechaInicio`, `proyectoFechaFin`, `proyectoFecha`) VALUES
(00001, 00001, 'Cuerpo saludable', 'Tener un cuerpo saludable y muy cuidado.', 'Pendiente', 'salud, ejercicio, fit', '2022-02-21', '2022-12-31', '2022-02-20 15:25:08');
...
--
ALTER TABLE `metas`
  MODIFY `metaId` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `proyectos`
--
ALTER TABLE `proyectos`
  MODIFY `proyectoId` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
