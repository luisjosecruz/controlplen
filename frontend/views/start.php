                        ...
                        <div class="home-grid">
                            ...
                            <div class="home-grid-box home-values">
                                <div class="add-values">
                                    <form id="" class="add-goals form-group">
                                        <input type="text" placeholder="Cosas que más valoras" name="goal-desc">
                            ...
                            <div class="home-grid-box">
                                <div class="home-pro-temp">
                                    <img src="../assets/images/addpro.svg">
                                    <p>Comencemos a unir los puntos.</p>
                                </div>  
