        ...
        <article>
                            ...
                            <div class="home-grid-box">
                                <div class="home-card-temp home-card-info home-card-phrases">
                                    <p class="home-phrases">
                                        ...
                                        <span>Que gusto saber que estás avanzado con tus objetivos.</span>
                                    </p>
                                </div>
            ...
            <section class="sec-right">
                <div class="widget">
                    ...
                    <div class="calendar-weekly" id="calendarWeekly">
                        <!-- <div class="calendar-weekly-days">
                            <ul>
                                <li class="calenda-weekly-ctrls"><</li>
                                <li class="calenda-weekly-item">1</li>
                                <li class="calenda-weekly-item">2</li>
                                <li class="calenda-weekly-item">3</li>
                                <li class="calenda-weekly-item">4</li>
                                <li class="calenda-weekly-item active">5</li>
                                <li class="calenda-weekly-item">6</li>
                                <li class="calenda-weekly-item">7</li>
                                <li class="calenda-weekly-ctrls">></li>
                            </ul>
                        </div> -->
                    </div>
        ...
        <div class="welcome">
            <div class="welcome-part">
                ...
                <p class="welcome-text">
                    ...
                    Luego continuaremos con los proyectos y metas, lo cual constituirá la escencia de tu plan.
                </p>
            </div>
            <div class="welcome-part">
...
mobiscroll.datepicker('#calendarWeekly', {
    controls: ['calendar'],
    display: 'inline',
    calendarType: 'week',
    calendarSize: 1
